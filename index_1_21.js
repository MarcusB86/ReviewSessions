...
console.log(findBiggerNumber([9, 6, 31, 1]));
...
console.log(findString(["Hello", "Lotto", "Cat"]));
console.log(findString(["Play", "Gametime", "Baller"]));
...
const newArray = [
  ...
  console.log(matchId(newArray,"L79H_f"));
